...
import org.sdn.android.sdk.api.session.room.model.message.asMessageAudioEvent
import org.sdn.android.sdk.api.session.room.model.relation.RelationDefaultContent
import org.sdn.android.sdk.api.session.room.model.relation.isReply
import org.sdn.android.sdk.api.session.room.model.relation.shouldRenderInThread
import org.sdn.android.sdk.api.session.room.send.SendState
import org.sdn.android.sdk.api.session.threads.ThreadDetails
...
import org.sdn.android.sdk.internal.session.presence.model.PresenceContent
...
data class Event(
    ...
    fun sendStateError(): SDNError? {
        return sendStateDetails?.let {
            val sdnErrorAdapter = MoshiProvider.providesMoshi().adapter(SDNError::class.java)
            tryOrNull { sdnErrorAdapter.fromJson(it) }
        }
    }
