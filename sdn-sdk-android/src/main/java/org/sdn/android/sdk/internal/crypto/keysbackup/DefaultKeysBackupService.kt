...
package org.sdn.android.sdk.internal.crypto.keysbackup
...
import org.sdn.android.sdk.api.crypto.MXCRYPTO_ALGORITHM_MEGOLM_BACKUP
...
import org.sdn.android.sdk.api.listeners.StepProgressListener
import org.sdn.android.sdk.api.session.crypto.keysbackup.KeysBackupLastVersionResult
import org.sdn.android.sdk.api.session.crypto.keysbackup.KeysBackupService
import org.sdn.android.sdk.api.session.crypto.keysbackup.KeysBackupState
import org.sdn.android.sdk.api.session.crypto.keysbackup.KeysBackupStateListener
import org.sdn.android.sdk.api.session.crypto.keysbackup.KeysBackupVersionTrust
import org.sdn.android.sdk.api.session.crypto.keysbackup.KeysBackupVersionTrustSignature
import org.sdn.android.sdk.api.session.crypto.keysbackup.KeysVersion
import org.sdn.android.sdk.api.session.crypto.keysbackup.KeysVersionResult
import org.sdn.android.sdk.api.session.crypto.keysbackup.MegolmBackupAuthData
import org.sdn.android.sdk.api.session.crypto.keysbackup.MegolmBackupCreationInfo
import org.sdn.android.sdk.api.session.crypto.keysbackup.SavedKeyBackupKeyInfo
import org.sdn.android.sdk.api.session.crypto.keysbackup.computeRecoveryKey
import org.sdn.android.sdk.api.session.crypto.keysbackup.extractCurveKeyFromRecoveryKey
import org.sdn.android.sdk.api.session.crypto.keysbackup.toKeysVersionResult
...
import org.sdn.android.sdk.internal.crypto.InboundGroupSessionStore
import org.sdn.android.sdk.internal.crypto.MXOlmDevice
import org.sdn.android.sdk.internal.crypto.MegolmSessionData
import org.sdn.android.sdk.internal.crypto.ObjectSigner
import org.sdn.android.sdk.internal.crypto.actions.MegolmSessionDataImporter
import org.sdn.android.sdk.internal.crypto.crosssigning.CrossSigningOlm
import org.sdn.android.sdk.internal.crypto.keysbackup.model.SignalableMegolmBackupAuthData
import org.sdn.android.sdk.internal.crypto.keysbackup.model.rest.BackupKeysResult
import org.sdn.android.sdk.internal.crypto.keysbackup.model.rest.CreateKeysBackupVersionBody
import org.sdn.android.sdk.internal.crypto.keysbackup.model.rest.KeyBackupData
import org.sdn.android.sdk.internal.crypto.keysbackup.model.rest.KeysBackupData
...
import org.sdn.android.sdk.internal.extensions.foldToCallback
...
internal class DefaultKeysBackupService @Inject constructor(
    ...
    private var backupAllGroupSessionsCallback: SDNCallback<Unit>? = null
    ...
    override fun prepareKeysBackupVersion(
            ...
            callback: SDNCallback<MegolmBackupCreationInfo>
    ) {
    ...
    override fun createKeysBackupVersion(
            ...
            callback: SDNCallback<KeysVersion>
    ) {
        ...
        createKeysBackupVersionTask
                .configureWith(createKeysBackupVersionBody) {
                    this.callback = object : SDNCallback<KeysVersion> {
    ...
    override fun deleteBackup(version: String, callback: SDNCallback<Unit>?) {
        cryptoCoroutineScope.launch(coroutineDispatchers.io) {
            ...
            deleteBackupTask
                    .configureWith(DeleteBackupTask.Params(version)) {
                        this.callback = object : SDNCallback<Unit> {
    ...
    override fun getKeysBackupTrust(
            ...
            callback: SDNCallback<KeysBackupVersionTrust>
    ) {
    ...
    override fun restoreKeysWithRecoveryKey(
            ...
            callback: SDNCallback<ImportRoomKeysResult>
    ) {
        ...
        cryptoCoroutineScope.launch(coroutineDispatchers.io) {
            ...
            }.foldToCallback(object : SDNCallback<ImportRoomKeysResult> {
    ...
    override fun getVersion(
            version: String,
            callback: SDNCallback<KeysVersionResult?>
    ) {
        getKeysBackupVersionTask
                .configureWith(version) {
                    this.callback = object : SDNCallback<KeysVersionResult> {
                        ...
                        override fun onFailure(failure: Throwable) {
                            if (failure is Failure.ServerError &&
                                    failure.error.code == SDNError.M_NOT_FOUND) {
    ...
    override fun getCurrentVersion(callback: SDNCallback<KeysBackupLastVersionResult>) {
    ...
    override fun forceUsingLastVersion(callback: SDNCallback<Boolean>) {
        getCurrentVersion(object : SDNCallback<KeysBackupLastVersionResult> {
    ...
    private fun checkAndStartWithKeysBackupVersion(keyBackupVersion: KeysVersionResult?) {
        ...
        if (keyBackupVersion == null) {
            ...
            getKeysBackupTrust(keyBackupVersion, object : SDNCallback<KeysBackupVersionTrust> {
 ...
 * ========================================================================================== */
    ...
    override fun isValidRecoveryKeyForCurrentVersion(recoveryKey: String, callback: SDNCallback<Boolean>) {
            ...
            withContext(coroutineDispatchers.crypto) {
                ...
                storeSessionDataTask
                        .configureWith(StoreSessionsDataTask.Params(version, keysBackupData)) {
                            this.callback = object : SDNCallback<BackupKeysResult> {
                                    ...
                                    if (failure is Failure.ServerError) {
                                        uiHandler.post {
                                            ...
                                            when (failure.error.code) {
                                                SDNError.M_NOT_FOUND,
                                                SDNError.M_WRONG_ROOM_KEYS_VERSION -> {
