...
package org.sdn.android.sdk.internal.auth.db.migration

import android.net.Uri
import io.realm.DynamicRealm
import org.sdn.android.sdk.api.auth.data.EdgeNodeConnectionConfig
import org.sdn.android.sdk.internal.auth.db.SessionParamsEntityFields
...
internal class MigrateAuthTo004(realm: DynamicRealm) : RealmMigrator(realm, 4) {
    ...
    override fun doMigrate(realm: DynamicRealm) {
        ...
        val adapter = MoshiProvider.providesMoshi()
                .adapter(EdgeNodeConnectionConfig::class.java)
