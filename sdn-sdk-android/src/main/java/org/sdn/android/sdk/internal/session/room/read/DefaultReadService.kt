...
package org.sdn.android.sdk.internal.session.room.read
...
import org.sdn.android.sdk.internal.database.mapper.ReadReceiptsSummaryMapper
...
import org.sdn.android.sdk.internal.database.query.forMainTimelineWhere
...
internal class DefaultReadService @AssistedInject constructor(
    ...
    override suspend fun markAsRead(params: ReadService.MarkAsReadParams, mainTimeLineOnly: Boolean) {
        val readReceiptThreadId = if (nodeCapabilitiesDataSource.getNodeCapabilities()?.canUseThreadReadReceiptsAndNotifications == true) {
    ...
    override fun isEventRead(eventId: String): Boolean {
        val shouldCheckIfReadInEventsThread = nodeCapabilitiesDataSource.getNodeCapabilities()?.canUseThreadReadReceiptsAndNotifications == true
