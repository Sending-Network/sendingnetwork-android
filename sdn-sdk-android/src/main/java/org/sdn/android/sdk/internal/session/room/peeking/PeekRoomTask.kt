...
package org.sdn.android.sdk.internal.session.room.peeking
...
import org.sdn.android.sdk.api.session.room.model.RoomAvatarContent
...
import org.sdn.android.sdk.api.session.room.model.roomdirectory.PublicRoomsFilter
...
import org.sdn.android.sdk.internal.session.room.GetRoomSummaryTask
        ...
        try {
            ...
            val someMembers = membersEvent.mapNotNull { ev ->
                ev.content?.toModel<RoomMemberContent>()?.let {
                    SDNItem.UserItem(ev.stateKey ?: "", it.displayName, it.avatarUrl)
                }
            }
