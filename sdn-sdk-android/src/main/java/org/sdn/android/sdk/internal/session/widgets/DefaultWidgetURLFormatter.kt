...
import org.sdn.android.sdk.api.session.widgets.WidgetURLFormatter
import org.sdn.android.sdk.api.util.appendParamToUrl
import org.sdn.android.sdk.api.util.appendParamsToUrl
...
import org.sdn.android.sdk.internal.session.widgets.token.GetScalarTokenTask
...
internal class DefaultWidgetURLFormatter @Inject constructor(
    ...
    private fun setupWithConfiguration() {
        ...
        if (!this::currentConfig.isInitialized || preferredConfig != currentConfig) {
            ...
            whiteListedUrls = if (sdnConfiguration.integrationWidgetUrls.isEmpty()) {
                listOf(preferredConfig.restUrl)
            } else {
                sdnConfiguration.integrationWidgetUrls
            }
        }
    }
