...
import org.sdn.android.sdk.internal.session.widgets.WidgetsAPI
import org.sdn.android.sdk.internal.session.widgets.WidgetsAPIProvider
    ...
    private suspend fun validateToken(widgetsAPI: WidgetsAPI, serverUrl: String, scalarToken: String): String {
        return try {
            ...
            if (failure is Failure.ServerError && failure.httpCode == HttpsURLConnection.HTTP_FORBIDDEN) {
                if (failure.error.code == SDNError.M_TERMS_NOT_SIGNED) {
