...
import org.sdn.android.sdk.api.session.node.RoomCapabilitySupport
import org.sdn.android.sdk.api.session.node.RoomVersionCapabilities
import org.sdn.android.sdk.api.session.node.RoomVersionInfo
import org.sdn.android.sdk.api.session.node.RoomVersionStatus
...
import org.sdn.android.sdk.internal.session.node.RoomVersions
 ...
 */
internal object NodeCapabilitiesMapper {

    fun map(entity: HomeServerCapabilitiesEntity): NodeCapabilities {
