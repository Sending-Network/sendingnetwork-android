...
package org.sdn.android.sdk.internal.session.content
...
import org.sdn.android.sdk.api.session.crypto.model.EncryptedFileInfo
...
import org.sdn.android.sdk.api.util.MimeTypes
import org.sdn.android.sdk.internal.SessionManager
import org.sdn.android.sdk.internal.crypto.attachments.MXEncryptedAttachments
...
import org.sdn.android.sdk.internal.network.ProgressRequestBody
...
import org.sdn.android.sdk.internal.session.room.send.CancelSendTracker
import org.sdn.android.sdk.internal.session.room.send.LocalEchoIdentifiers
...
import org.sdn.android.sdk.internal.util.TemporaryFileCreator
import org.sdn.android.sdk.internal.util.time.Clock
import org.sdn.android.sdk.internal.util.toSDNErrorStr
import org.sdn.android.sdk.internal.worker.SessionSafeCoroutineWorker
import org.sdn.android.sdk.internal.worker.SessionWorkerParams
...
internal class UploadContentWorker(val context: Context, params: WorkerParameters, sessionManager: SessionManager) :
    ...
    private fun handleFailure(params: Params, failure: Throwable): Result {
        ...
        return Result.success(
                WorkerParamsFactory.toData(
                        params.copy(
                                lastFailureMessage = failure.toSDNErrorStr()
                        )
                )
        )
    }
