...
package org.sdn.android.sdk.internal.session.widgets.helper
...
import org.sdn.android.sdk.internal.session.user.UserDataSource
...
internal class WidgetFactory @Inject constructor(
    ...
    fun computeURL(widget: Widget, isLightTheme: Boolean): String? {
        ...
        keyValue[WIDGET_PATTERN_MATRIX_DISPLAY_NAME] = displayNameResolver.getBestName(myUser.toSDNItem())
