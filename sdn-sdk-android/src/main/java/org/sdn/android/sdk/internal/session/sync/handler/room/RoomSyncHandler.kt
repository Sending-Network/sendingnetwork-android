...
import org.sdn.android.sdk.api.session.events.model.getRelationContent
...
import org.sdn.android.sdk.api.session.sync.InitialSyncStrategy
import org.sdn.android.sdk.api.session.sync.initialSyncStrategy
import org.sdn.android.sdk.api.session.sync.model.InvitedRoomSync
import org.sdn.android.sdk.api.session.sync.model.LazyRoomSyncEphemeral
import org.sdn.android.sdk.api.session.sync.model.RoomSync
import org.sdn.android.sdk.api.session.sync.model.RoomsSyncResponse
...
import org.sdn.android.sdk.internal.database.helper.addIfNecessary
import org.sdn.android.sdk.internal.database.helper.addTimelineEvent
import org.sdn.android.sdk.internal.database.helper.createOrUpdate
import org.sdn.android.sdk.internal.database.helper.updateThreadSummaryIfNeeded
import org.sdn.android.sdk.internal.database.mapper.asDomain
import org.sdn.android.sdk.internal.database.mapper.toEntity
import org.sdn.android.sdk.internal.database.model.ChunkEntity
import org.sdn.android.sdk.internal.database.model.CurrentStateEventEntity
import org.sdn.android.sdk.internal.database.model.EventAnnotationsSummaryEntity
...
import org.sdn.android.sdk.internal.database.query.copyToRealmOrIgnore
import org.sdn.android.sdk.internal.database.query.find
import org.sdn.android.sdk.internal.database.query.findAll
import org.sdn.android.sdk.internal.database.query.findLastForwardChunkOfRoom
import org.sdn.android.sdk.internal.database.query.findLastForwardChunkOfThread
import org.sdn.android.sdk.internal.database.query.getOrCreate
import org.sdn.android.sdk.internal.database.query.getOrNull
...
import org.sdn.android.sdk.internal.session.events.getFixedRoomMemberContent
...
import org.sdn.android.sdk.internal.session.sync.ProgressReporter
import org.sdn.android.sdk.internal.session.sync.SyncResponsePostTreatmentAggregator
import org.sdn.android.sdk.internal.session.sync.mapWithProgress
import org.sdn.android.sdk.internal.session.sync.parsing.RoomSyncAccountDataHandler
import org.sdn.android.sdk.internal.session.sync.reportSubtask
import org.sdn.android.sdk.internal.util.computeBestChunkSize
...
internal class RoomSyncHandler @Inject constructor(
    ...
    private val nodeCapabilitiesService: NodeCapabilitiesService,
        ...
        for (rawEvent in eventList) {
            ...
            if (lightweightSettingsStorage.areThreadMessagesEnabled()) {
                eventEntity.rootThreadEventId?.let {
                    ...
                    if (nodeCapabilitiesService.getNodeCapabilities().canUseThreading) {
