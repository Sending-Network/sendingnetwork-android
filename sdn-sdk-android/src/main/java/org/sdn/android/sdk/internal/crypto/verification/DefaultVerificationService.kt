...
package org.sdn.android.sdk.internal.crypto.verification
...
import org.sdn.android.sdk.api.session.crypto.crosssigning.KEYBACKUP_SECRET_SSSS_NAME
import org.sdn.android.sdk.api.session.crypto.crosssigning.MASTER_KEY_SSSS_NAME
import org.sdn.android.sdk.api.session.crypto.crosssigning.SELF_SIGNING_KEY_SSSS_NAME
import org.sdn.android.sdk.api.session.crypto.crosssigning.USER_SIGNING_KEY_SSSS_NAME
...
import org.sdn.android.sdk.api.session.crypto.verification.CancelCode
import org.sdn.android.sdk.api.session.crypto.verification.PendingVerificationRequest
import org.sdn.android.sdk.api.session.crypto.verification.QrCodeVerificationTransaction
import org.sdn.android.sdk.api.session.crypto.verification.SasVerificationTransaction
import org.sdn.android.sdk.api.session.crypto.verification.ValidVerificationInfoReady
import org.sdn.android.sdk.api.session.crypto.verification.VerificationMethod
import org.sdn.android.sdk.api.session.crypto.verification.VerificationService
import org.sdn.android.sdk.api.session.crypto.verification.VerificationTransaction
import org.sdn.android.sdk.api.session.crypto.verification.VerificationTxState
import org.sdn.android.sdk.api.session.crypto.verification.safeValueOf
...
import org.sdn.android.sdk.api.session.room.model.message.MessageRelationContent
import org.sdn.android.sdk.api.session.room.model.message.MessageType
import org.sdn.android.sdk.api.session.room.model.message.MessageVerificationAcceptContent
import org.sdn.android.sdk.api.session.room.model.message.MessageVerificationCancelContent
import org.sdn.android.sdk.api.session.room.model.message.MessageVerificationDoneContent
import org.sdn.android.sdk.api.session.room.model.message.MessageVerificationKeyContent
import org.sdn.android.sdk.api.session.room.model.message.MessageVerificationMacContent
import org.sdn.android.sdk.api.session.room.model.message.MessageVerificationReadyContent
import org.sdn.android.sdk.api.session.room.model.message.MessageVerificationRequestContent
import org.sdn.android.sdk.api.session.room.model.message.MessageVerificationStartContent
import org.sdn.android.sdk.api.session.room.model.message.ValidVerificationDone
import org.sdn.android.sdk.internal.crypto.DeviceListManager
import org.sdn.android.sdk.internal.crypto.MyDeviceInfoHolder
import org.sdn.android.sdk.internal.crypto.OutgoingKeyRequestManager
import org.sdn.android.sdk.internal.crypto.SecretShareManager
import org.sdn.android.sdk.internal.crypto.actions.SetDeviceVerificationAction
import org.sdn.android.sdk.internal.crypto.model.rest.KeyVerificationAccept
import org.sdn.android.sdk.internal.crypto.model.rest.KeyVerificationCancel
import org.sdn.android.sdk.internal.crypto.model.rest.KeyVerificationDone
import org.sdn.android.sdk.internal.crypto.model.rest.KeyVerificationKey
import org.sdn.android.sdk.internal.crypto.model.rest.KeyVerificationMac
import org.sdn.android.sdk.internal.crypto.model.rest.KeyVerificationReady
import org.sdn.android.sdk.internal.crypto.model.rest.KeyVerificationRequest
import org.sdn.android.sdk.internal.crypto.model.rest.KeyVerificationStart
import org.sdn.android.sdk.internal.crypto.model.rest.VERIFICATION_METHOD_QR_CODE_SCAN
import org.sdn.android.sdk.internal.crypto.model.rest.VERIFICATION_METHOD_QR_CODE_SHOW
import org.sdn.android.sdk.internal.crypto.model.rest.VERIFICATION_METHOD_RECIPROCATE
import org.sdn.android.sdk.internal.crypto.model.rest.VERIFICATION_METHOD_SAS
import org.sdn.android.sdk.internal.crypto.model.rest.toValue
import org.sdn.android.sdk.internal.crypto.store.IMXCryptoStore
import org.sdn.android.sdk.internal.crypto.verification.qrcode.DefaultQrCodeVerificationTransaction
import org.sdn.android.sdk.internal.crypto.verification.qrcode.QrCodeData
import org.sdn.android.sdk.internal.crypto.verification.qrcode.generateSharedSecretV2
