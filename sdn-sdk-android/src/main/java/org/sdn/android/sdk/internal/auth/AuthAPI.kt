...
import org.sdn.android.sdk.internal.auth.data.*
import org.sdn.android.sdk.internal.auth.data.Availability
import org.sdn.android.sdk.internal.auth.data.LoginFlowResponse
...
import org.sdn.android.sdk.internal.auth.login.ResetPasswordMailConfirmed
import org.sdn.android.sdk.internal.auth.registration.AddThreePidRegistrationParams
import org.sdn.android.sdk.internal.auth.registration.AddThreePidRegistrationResponse
import org.sdn.android.sdk.internal.auth.registration.RegistrationCustomParams
import org.sdn.android.sdk.internal.auth.registration.RegistrationParams
import org.sdn.android.sdk.internal.auth.registration.SuccessResult
import org.sdn.android.sdk.internal.auth.registration.ValidationCodeBody
...
internal interface AuthAPI {
    ...
    @POST(NetworkConstants.URI_API_PREFIX_PATH_UNSTABLE + "did/create")
    suspend fun didCreate(@Body didCreateParams: DidCreateParams): DidCreateResp

    @Headers("CONNECT_TIMEOUT:60000", "READ_TIMEOUT:60000", "WRITE_TIMEOUT:60000")
    @POST(NetworkConstants.URI_API_PREFIX_PATH_UNSTABLE + "did/{did}")
    ...
    suspend fun login(@Body loginParams: DidLoginParams): Credentials
