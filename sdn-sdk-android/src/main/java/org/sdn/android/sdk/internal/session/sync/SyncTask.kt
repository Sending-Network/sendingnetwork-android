...
import org.sdn.android.sdk.api.session.statistics.StatisticEvent
...
import org.sdn.android.sdk.api.session.sync.SyncRequestState
import org.sdn.android.sdk.api.session.sync.initialSyncStrategy
...
import org.sdn.android.sdk.internal.network.TimeOutInterceptor
import org.sdn.android.sdk.internal.network.executeRequest
import org.sdn.android.sdk.internal.network.toFailure
import org.sdn.android.sdk.internal.session.SessionListeners
import org.sdn.android.sdk.internal.session.dispatchTo
import org.sdn.android.sdk.internal.session.filter.GetCurrentFilterTask
import org.sdn.android.sdk.internal.session.node.GetNodeCapabilitiesTask
import org.sdn.android.sdk.internal.session.sync.parsing.InitialSyncResponseParser
import org.sdn.android.sdk.internal.session.user.UserStore
import org.sdn.android.sdk.internal.task.Task
import org.sdn.android.sdk.internal.util.logDuration
...
internal class DefaultSyncTask @Inject constructor(
    ...
    private suspend fun doSync(params: SyncTask.Params): SyncResponse {
        ...
        getNodeCapabilitiesTask.execute(GetNodeCapabilitiesTask.Params(forceRefresh = false))
