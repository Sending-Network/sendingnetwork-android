...
import org.sdn.android.sdk.internal.util.removeInvalidRoomNameChars
import org.sdn.android.sdk.internal.util.replaceSpaceChars
...
object MatrixPatterns {
    ...
    fun candidateAliasFromRoomName(roomName: String, domain: String): String {
        return roomName.lowercase()
                ...
                .take(SDNConstants.maxAliasLocalPartLength(domain))
    }
