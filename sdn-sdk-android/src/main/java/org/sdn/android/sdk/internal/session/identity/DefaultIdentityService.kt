...
package org.sdn.android.sdk.internal.session.identity
...
import org.sdn.android.sdk.api.session.identity.FoundThreePid
...
import org.sdn.android.sdk.api.session.identity.IdentityServiceListener
import org.sdn.android.sdk.api.session.identity.SharedState
...
import org.sdn.android.sdk.internal.extensions.observeNotNull
...
import org.sdn.android.sdk.internal.session.openid.GetOpenIdTokenTask
import org.sdn.android.sdk.internal.session.profile.BindThreePidsTask
import org.sdn.android.sdk.internal.session.profile.UnbindThreePidsTask
import org.sdn.android.sdk.internal.session.sync.model.accountdata.IdentityServerContent
import org.sdn.android.sdk.internal.session.user.accountdata.UpdateUserAccountDataTask
import org.sdn.android.sdk.internal.session.user.accountdata.UserAccountDataDataSource
import org.sdn.android.sdk.internal.util.ensureProtocol
...
internal class DefaultIdentityService @Inject constructor(
    ...
    override fun getDefaultIdentityServer(): String? {
        return sessionParams.defaultIdentityServerUrl
                ...
                ?: nodeCapabilitiesService.getNodeCapabilities().defaultIdentityServerUrl
    }
    ...
    override suspend fun startBindThreePid(threePid: ThreePid) {
        if (nodeCapabilitiesService.getNodeCapabilities().lastVersionIdentityServerSupported.not()) {
...
private fun Throwable.isTermsNotSigned(): Boolean {
    return this is Failure.ServerError &&
            ...
            error.code == SDNError.M_TERMS_NOT_SIGNED
}
