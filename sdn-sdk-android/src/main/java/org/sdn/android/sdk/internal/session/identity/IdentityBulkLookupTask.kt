...
import org.sdn.android.sdk.internal.crypto.tools.withOlmUtility
...
import org.sdn.android.sdk.internal.util.base64ToBase64Url
...
internal class DefaultIdentityBulkLookupTask @Inject constructor(
    ...
    private suspend fun lookUpInternal(
        ...
        return try {
            ...
            if (canRetry && failure is Failure.ServerError && failure.error.code == SDNError.M_INVALID_PEPPER) {
