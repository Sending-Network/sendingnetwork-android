...
package org.sdn.android.sdk.internal.network.ssl
...
internal object CertUtil {
     ...
     */
    fun newPinnedSSLSocketFactory(hsConfig: EdgeNodeConnectionConfig): PinnedSSLSocketFactory {
        try {
     ...
     */
    fun newHostnameVerifier(hsConfig: EdgeNodeConnectionConfig): HostnameVerifier {
     ...
     */
    fun newConnectionSpecs(hsConfig: EdgeNodeConnectionConfig): List<ConnectionSpec> {
