...
import org.sdn.android.sdk.api.MatrixUrls.removeMxcPrefix
...
import org.sdn.android.sdk.internal.session.contentscanner.model.toJson
...
internal class DefaultContentUrlResolver @Inject constructor(
    ...
    private val baseUrl = edgeNodeConnectionConfig.homeServerUriBase.toString().ensureTrailingSlash()
