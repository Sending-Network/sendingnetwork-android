...
internal abstract class NodeCapabilitiesModule {
    ...
    @Binds
    abstract fun bindGetHomeServerCapabilitiesTask(task: DefaultGetNodeCapabilitiesTask): GetNodeCapabilitiesTask
}
