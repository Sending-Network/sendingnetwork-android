...
import org.sdn.android.sdk.internal.database.model.PendingThreePidEntity
import org.sdn.android.sdk.internal.database.model.UserThreePidEntity
...
internal class DefaultProfileService @Inject constructor(
    ...
    override suspend fun setAvatarUrl(userId: String, newAvatarUri: Uri) {
        setAvatarUrlTask.execute(SetAvatarUrlTask.Params(userId = userId, newAvatarUrl = newAvatarUri.toString()))
    }
