...
package org.sdn.android.sdk.internal.session.integrationmanager
...
import org.sdn.android.sdk.api.session.integrationmanager.IntegrationManagerConfig
import org.sdn.android.sdk.api.session.integrationmanager.IntegrationManagerService
import org.sdn.android.sdk.api.session.widgets.model.WidgetContent
import org.sdn.android.sdk.api.session.widgets.model.WidgetType
import org.sdn.android.sdk.internal.database.model.WellknownIntegrationManagerConfigEntity
...
import org.sdn.android.sdk.internal.session.widgets.helper.WidgetFactory
import org.sdn.android.sdk.internal.session.widgets.helper.extractWidgetSequence
...
internal class IntegrationManager @Inject constructor(
    ...
    init {
        val defaultConfig = IntegrationManagerConfig(
                uiUrl = sdnConfiguration.integrationUIUrl,
                restUrl = sdnConfiguration.integrationRestUrl,
