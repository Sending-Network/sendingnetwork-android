...
import org.sdn.android.sdk.api.session.SessionLifecycleObserver
import org.sdn.android.sdk.api.session.ToDeviceService
import org.sdn.android.sdk.api.session.accountdata.SessionAccountDataService
import org.sdn.android.sdk.api.session.events.EventService
import org.sdn.android.sdk.api.session.node.NodeCapabilitiesService
import org.sdn.android.sdk.api.session.openid.OpenIdService
import org.sdn.android.sdk.api.session.permalinks.PermalinkService
import org.sdn.android.sdk.api.session.securestorage.SharedSecretStorageService
import org.sdn.android.sdk.api.session.typing.TypingUsersTracker
import org.sdn.android.sdk.api.util.md5
import org.sdn.android.sdk.internal.crypto.secrets.DefaultSharedSecretStorageService
import org.sdn.android.sdk.internal.crypto.tasks.DefaultRedactEventTask
import org.sdn.android.sdk.internal.crypto.tasks.RedactEventTask
import org.sdn.android.sdk.internal.database.EventInsertLiveObserver
import org.sdn.android.sdk.internal.database.RealmSessionProvider
import org.sdn.android.sdk.internal.database.SessionRealmConfigurationFactory
import org.sdn.android.sdk.internal.di.Authenticated
import org.sdn.android.sdk.internal.di.CacheDirectory
import org.sdn.android.sdk.internal.di.DeviceId
import org.sdn.android.sdk.internal.di.SessionDatabase
import org.sdn.android.sdk.internal.di.SessionDownloadsDirectory
...
import org.sdn.android.sdk.internal.di.UnauthenticatedWithCertificate
import org.sdn.android.sdk.internal.di.UnauthenticatedWithCertificateWithProgress
import org.sdn.android.sdk.internal.di.UserId
import org.sdn.android.sdk.internal.di.UserMd5
import org.sdn.android.sdk.internal.network.DefaultNetworkConnectivityChecker
import org.sdn.android.sdk.internal.network.FallbackNetworkCallbackStrategy
import org.sdn.android.sdk.internal.network.GlobalErrorHandler
import org.sdn.android.sdk.internal.network.GlobalErrorReceiver
import org.sdn.android.sdk.internal.network.NetworkCallbackStrategy
import org.sdn.android.sdk.internal.network.NetworkConnectivityChecker
import org.sdn.android.sdk.internal.network.PreferredNetworkCallbackStrategy
import org.sdn.android.sdk.internal.network.RetrofitFactory
import org.sdn.android.sdk.internal.network.httpclient.addAccessTokenInterceptor
import org.sdn.android.sdk.internal.network.httpclient.addSocketFactory
import org.sdn.android.sdk.internal.network.httpclient.applySDNConfiguration
...
import org.sdn.android.sdk.internal.network.token.HomeserverAccessTokenProvider
import org.sdn.android.sdk.internal.session.call.CallEventProcessor
import org.sdn.android.sdk.internal.session.download.DownloadProgressInterceptor
import org.sdn.android.sdk.internal.session.events.DefaultEventService
import org.sdn.android.sdk.internal.session.node.DefaultNodeCapabilitiesService
import org.sdn.android.sdk.internal.session.identity.DefaultIdentityService
import org.sdn.android.sdk.internal.session.integrationmanager.IntegrationManager
import org.sdn.android.sdk.internal.session.openid.DefaultOpenIdService
import org.sdn.android.sdk.internal.session.permalinks.DefaultPermalinkService
import org.sdn.android.sdk.internal.session.room.EventRelationsAggregationProcessor
import org.sdn.android.sdk.internal.session.room.aggregation.poll.DefaultPollAggregationProcessor
import org.sdn.android.sdk.internal.session.room.aggregation.poll.PollAggregationProcessor
import org.sdn.android.sdk.internal.session.room.create.RoomCreateEventProcessor
import org.sdn.android.sdk.internal.session.room.location.LiveLocationShareRedactionEventProcessor
import org.sdn.android.sdk.internal.session.room.prune.RedactionEventProcessor
import org.sdn.android.sdk.internal.session.room.send.queue.EventSenderProcessor
import org.sdn.android.sdk.internal.session.room.send.queue.EventSenderProcessorCoroutine
import org.sdn.android.sdk.internal.session.room.tombstone.RoomTombstoneEventProcessor
import org.sdn.android.sdk.internal.session.typing.DefaultTypingUsersTracker
import org.sdn.android.sdk.internal.session.user.accountdata.DefaultSessionAccountDataService
import org.sdn.android.sdk.internal.session.widgets.DefaultWidgetURLFormatter
...
internal abstract class SessionModule {
    ...
    companion object {
        ...
        @JvmStatic
        @Provides
        fun providesHomeServerConnectionConfig(sessionParams: SessionParams): EdgeNodeConnectionConfig {
            return sessionParams.edgeNodeConnectionConfig
        }
        ...
        fun providesOkHttpClient(
            ...
            return okHttpClient
                    ...
                    .applySDNConfiguration(sdnConfiguration)
                    .build()
        }
        ...
        fun providesRetrofit(
            ...
            return retrofitFactory
                    .create(okHttpClient, sessionParams.edgeNodeConnectionConfig.homeServerUriBase.toString())
        }
        ...
        @Provides
        @SessionScope
        fun providesMxCryptoConfig(sdnConfiguration: SDNConfiguration): MXCryptoConfig {
            return sdnConfiguration.cryptoConfig
        }
    }
    ...
    @Binds
    abstract fun bindHomeServerCapabilitiesService(service: DefaultNodeCapabilitiesService): NodeCapabilitiesService
