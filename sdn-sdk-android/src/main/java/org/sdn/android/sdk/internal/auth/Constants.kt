 ...
 */
internal const val LOGIN_FALLBACK_PATH = "/_api/static/client/login/"

/**
 * Path to use when the client does not supported any or all registration flows.
 * Not documented.
 */
internal const val REGISTER_FALLBACK_PATH = "/_api/static/client/register/"
 ...
 */
internal const val SSO_REDIRECT_PATH = "/_api/client/r0/login/sso/redirect"

internal const val SSO_REDIRECT_URL_PARAM = "redirectUrl"

// Ref: https://matrix.org/docs/spec/client_server/r0.6.1#single-sign-on
internal const val SSO_UIA_FALLBACK_PATH = "/_api/client/r0/auth/m.login.sso/fallback/web"
