...
package org.sdn.android.sdk.internal.session.room.version
...
internal class DefaultRoomVersionService @AssistedInject constructor(
    ...
    override fun getRecommendedVersion(): String {
        return nodeCapabilitiesDataSource.getNodeCapabilities()?.roomVersions?.defaultRoomVersion ?: DEFAULT_ROOM_VERSION
    }

    override fun isUsingUnstableRoomVersion(): Boolean {
        val versionCaps = nodeCapabilitiesDataSource.getNodeCapabilities()?.roomVersions
