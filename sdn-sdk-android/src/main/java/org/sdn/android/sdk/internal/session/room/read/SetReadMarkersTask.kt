...
import org.sdn.android.sdk.internal.database.query.isReadMarkerMoreRecent
import org.sdn.android.sdk.internal.database.query.latestEvent
...
import org.sdn.android.sdk.internal.session.sync.handler.room.ReadReceiptHandler
...
internal class DefaultSetReadMarkersTask @Inject constructor(
    ...
    override suspend fun execute(params: SetReadMarkersTask.Params) {
        ...
        val shouldCheckIfReadInEventsThread = readReceiptThreadId != null &&
                nodeCapabilitiesService.getNodeCapabilities().canUseThreadReadReceiptsAndNotifications
