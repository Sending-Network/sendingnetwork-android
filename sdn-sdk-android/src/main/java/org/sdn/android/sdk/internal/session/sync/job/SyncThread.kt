...
package org.sdn.android.sdk.internal.session.sync.job
...
import org.sdn.android.sdk.api.failure.isTokenError
import org.sdn.android.sdk.api.logger.LoggerTag
import org.sdn.android.sdk.api.session.call.MxCall
import org.sdn.android.sdk.api.session.sync.SyncState
...
import org.sdn.android.sdk.internal.session.call.ActiveCallHandler
...
import org.sdn.android.sdk.internal.util.Debouncer
        ...
        while (state != SyncState.Killing) {
            ...
            if (!isStarted) {
                ...
                val timeout = when {
                    ...
                    else -> sdnConfiguration.syncConfig.longPollTimeout
                }
