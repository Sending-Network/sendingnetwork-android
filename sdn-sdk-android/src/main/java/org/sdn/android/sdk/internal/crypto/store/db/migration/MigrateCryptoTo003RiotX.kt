...
import org.sdn.androidsdk.crypto.data.MXDeviceInfo
import org.sdn.androidsdk.crypto.data.MXOlmInboundGroupSession2
                ...
                ?.transform { obj ->
                    try {
                        ...
                        deserializeFromRealm<MXDeviceInfo>(oldSerializedData)?.let { legacyMxDeviceInfo ->
                            val newMxDeviceInfo = org.sdn.android.sdk.api.session.crypto.model.MXDeviceInfo(
