...
import org.sdn.android.sdk.api.auth.data.EdgeNodeConnectionConfig.Builder
...
data class EdgeNodeConnectionConfig(
    ...
    /**
     * This builder should be use to create a [EdgeNodeConnectionConfig] instance.
     */
    class Builder {
        private lateinit var nodeUri: Uri
        ...
        fun withNodeUri(hsUriString: String): Builder {
            return withNodeUri(Uri.parse(hsUriString))
        }
         ...
         * @return this builder
         */
        fun withNodeUri(hsUri: Uri): Builder {
        ...
        /**
         * @return the [EdgeNodeConnectionConfig]
         */
        fun build(): EdgeNodeConnectionConfig {
            return EdgeNodeConnectionConfig(
                    homeServerUri = nodeUri,
