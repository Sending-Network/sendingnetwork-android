...
import org.sdn.android.sdk.api.auth.data.DidListResp
...
internal interface DidListTask : Task<DidListTask.Params, DidListResp> {
    data class Params(
...
internal class DefaultDidListTask @Inject constructor(
        @Unauthenticated
        private val okHttpClient: Lazy<OkHttpClient>,
        private val retrofitFactory: RetrofitFactory,
) : DidListTask {

    override suspend fun execute(params: DidListTask.Params): DidListResp {
