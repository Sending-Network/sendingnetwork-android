...
import org.sdn.android.sdk.api.session.room.timeline.Timeline
import org.sdn.android.sdk.api.session.room.timeline.TimelineEvent
import org.sdn.android.sdk.api.session.room.timeline.TimelineSettings
...
import org.sdn.android.sdk.internal.database.mapper.TimelineEventMapper
import org.sdn.android.sdk.internal.database.model.ChunkEntity
import org.sdn.android.sdk.internal.database.model.ChunkEntityFields
import org.sdn.android.sdk.internal.database.model.RoomEntity
import org.sdn.android.sdk.internal.database.model.deleteAndClearThreadEvents
import org.sdn.android.sdk.internal.database.query.findAllIncludingEvents
...
import org.sdn.android.sdk.internal.session.sync.handler.room.ThreadsAwarenessHandler
...
//        }
    ...
    data class Dependencies(
        ...
        val sdnCoroutineDispatchers: SDNCoroutineDispatchers,
    )
    ...
    private val liveRoomStateListener = LiveRoomStateListener(
            ...
            dependencies.sdnCoroutineDispatchers.main
    )
    ...
    suspend fun loadMore(count: Int, direction: Timeline.Direction, fetchOnServerIfNeeded: Boolean = true): LoadMoreResult {
        if (mode is Mode.Permalink && timelineChunk == null) {
            ...
            try {
                ...
                if (failure is Failure.ServerError && failure.error.code in listOf(SDNError.M_NOT_FOUND, SDNError.M_FORBIDDEN)) {
