...
import org.sdn.android.sdk.api.extensions.measureMetric
import org.sdn.android.sdk.api.extensions.measureSpan
import org.sdn.android.sdk.api.metrics.SyncDurationMetricPlugin
...
import org.sdn.android.sdk.internal.session.pushrules.ProcessEventForPushTask
import org.sdn.android.sdk.internal.session.sync.handler.CryptoSyncHandler
import org.sdn.android.sdk.internal.session.sync.handler.PresenceSyncHandler
import org.sdn.android.sdk.internal.session.sync.handler.SyncResponsePostTreatmentAggregatorHandler
import org.sdn.android.sdk.internal.session.sync.handler.UserAccountDataSyncHandler
import org.sdn.android.sdk.internal.session.sync.handler.room.RoomSyncHandler
...
internal class SyncResponseHandler @Inject constructor(
    ...
    private val relevantPlugins = sdnConfiguration.metricPlugins.filterIsInstance<SyncDurationMetricPlugin>()
