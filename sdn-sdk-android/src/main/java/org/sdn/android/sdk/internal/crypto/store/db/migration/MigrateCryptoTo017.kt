...
import org.sdn.android.sdk.internal.crypto.store.db.model.OutboundGroupSessionInfoEntityFields
                    ...
                    try {
                        ...
                        dynamicObject.getString(OlmInboundGroupSessionEntityFields.OLM_INBOUND_GROUP_SESSION_DATA)?.let { oldData ->
                            val oldWrapper = tryOrNull("Failed to convert megolm inbound group data") {
                                ...
                                deserializeFromRealm<org.sdn.android.sdk.internal.crypto.model.OlmInboundGroupSessionWrapper2?>(oldData)
                            }
