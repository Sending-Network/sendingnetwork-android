...
import org.sdn.android.sdk.api.legacy.LegacySessionImporter
import org.sdn.android.sdk.internal.auth.db.AuthRealmMigration
import org.sdn.android.sdk.internal.auth.db.AuthRealmModule
import org.sdn.android.sdk.internal.auth.db.RealmPendingSessionStore
import org.sdn.android.sdk.internal.auth.db.RealmSessionParamsStore
import org.sdn.android.sdk.internal.auth.login.*
import org.sdn.android.sdk.internal.auth.login.DefaultDidPreLoginTask
import org.sdn.android.sdk.internal.auth.login.DefaultDirectLoginTask
import org.sdn.android.sdk.internal.auth.login.DefaultQrLoginTokenTask
...
import org.sdn.android.sdk.internal.di.AuthDatabase
import org.sdn.android.sdk.internal.legacy.DefaultLegacySessionImporter
import org.sdn.android.sdk.internal.wellknown.WellknownModule
import java.io.File
...
internal abstract class AuthModule {
    ...
    @Binds
    abstract fun bindHomeServerHistoryService(service: DefaultNodeHistoryService): NodeHistoryService
    ...
    @Binds
    abstract fun bindDidCreateTask(task: DefaultDidCreateTask): DidCreateTask

    @Binds
    abstract fun bindDidSaveTask(task: DefaultDidSaveTask): DidSaveTask

    @Binds
    abstract fun bindDidPreLoginTask(task: DefaultDidPreLoginTask): DidPreLoginTask

    @Binds
    abstract fun bindDidLoginTask(task: DefaultDidLoginTask): DidLoginTask
}
