...
import org.sdn.android.sdk.api.auth.data.DidCreateResp
...
import org.sdn.android.sdk.internal.auth.data.DidCreateParams
...
internal interface DidCreateTask : Task<DidCreateTask.Params, DidCreateResp> {
    data class Params(
...
internal class DefaultDidCreateTask @Inject constructor(
        @Unauthenticated
        private val okHttpClient: Lazy<OkHttpClient>,
        private val retrofitFactory: RetrofitFactory,
) : DidCreateTask {

    override suspend fun execute(params: DidCreateTask.Params): DidCreateResp {
        ...
        val didCreateResp = try {
            executeRequest(null) {
                authAPI.didCreate(DidCreateParams(params.address))
            }
