...
package org.sdn.android.sdk.api
...
import org.sdn.android.sdk.api.debug.DebugService
import org.sdn.android.sdk.api.legacy.LegacySessionImporter
import org.sdn.android.sdk.api.network.ApiInterceptorListener
import org.sdn.android.sdk.api.network.ApiPath
...
import org.sdn.android.sdk.internal.di.DaggerSDNComponent
import org.sdn.android.sdk.internal.network.ApiInterceptor
import org.sdn.android.sdk.internal.network.UserAgentHolder
 ...
 * @param sdnConfiguration global configuration that will be used for every [org.matrix.android.sdk.api.session.Session]
 */
class SDNClient(context: Context, sdnConfiguration: SDNConfiguration) {
    ...
    @Inject internal lateinit var nodeHistoryService: NodeHistoryService
    @Inject internal lateinit var apiInterceptor: ApiInterceptor
    @Inject internal lateinit var sdnWorkerFactory: SDNWorkerFactory
    ...
    init {
        ...
        DaggerSDNComponent.factory().create(appContext, sdnConfiguration).inject(this)
        if (appContext !is Configuration.Provider) {
            val configuration = Configuration.Builder()
                    .setExecutor(Executors.newCachedThreadPool())
                    .setWorkerFactory(sdnWorkerFactory)
                    .build()
     ...
     */
    fun getWorkerFactory(): WorkerFactory = sdnWorkerFactory
