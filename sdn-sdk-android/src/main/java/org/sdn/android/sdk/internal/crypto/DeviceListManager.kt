...
import org.sdn.android.sdk.api.metrics.DownloadDeviceKeysMetricsPlugin
...
import org.sdn.android.sdk.internal.crypto.model.CryptoInfoMapper
...
internal class DeviceListManager @Inject constructor(
    ...
    coroutineDispatchers: SDNCoroutineDispatchers,
    private val taskExecutor: TaskExecutor,
    private val clock: Clock,
    sdnConfiguration: SDNConfiguration
) {

    private val metricPlugins = sdnConfiguration.metricPlugins
