...
package org.sdn.android.sdk.internal.settings
...
internal class DefaultLightweightSettingsStorage @Inject constructor(
    ...
    override fun areThreadMessagesEnabled(): Boolean {
        return sdkDefaultPrefs.getBoolean(MATRIX_SDK_SETTINGS_THREAD_MESSAGES_ENABLED, sdnConfiguration.threadMessagesEnabledDefault)
    }
