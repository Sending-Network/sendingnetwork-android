...
interface KeysBackupService {
     ...
     */
    fun getCurrentVersion(callback: SDNCallback<KeysBackupLastVersionResult>)
     ...
     */
    fun forceUsingLastVersion(callback: SDNCallback<Boolean>)
    ...
    fun isValidRecoveryKeyForCurrentVersion(recoveryKey: String, callback: SDNCallback<Boolean>)
