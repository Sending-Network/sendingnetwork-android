...
import org.sdn.android.sdk.api.failure.GlobalError
import org.sdn.android.sdk.api.federation.FederationService
...
import org.sdn.android.sdk.api.session.account.AccountService
...
import org.sdn.android.sdk.api.session.call.CallSignalingService
import org.sdn.android.sdk.api.session.content.ContentUploadStateTracker
import org.sdn.android.sdk.api.session.content.ContentUrlResolver
import org.sdn.android.sdk.api.session.contentscanner.ContentScannerService
import org.sdn.android.sdk.api.session.crypto.CryptoService
import org.sdn.android.sdk.api.session.events.EventService
import org.sdn.android.sdk.api.session.file.ContentDownloadStateTracker
...
import org.sdn.android.sdk.api.session.identity.IdentityService
import org.sdn.android.sdk.api.session.integrationmanager.IntegrationManagerService
import org.sdn.android.sdk.api.session.media.MediaService
...
import org.sdn.android.sdk.api.session.presence.PresenceService
import org.sdn.android.sdk.api.session.profile.ProfileService
import org.sdn.android.sdk.api.session.pushers.PushersService
import org.sdn.android.sdk.api.session.pushrules.PushRuleService
import org.sdn.android.sdk.api.session.room.RoomDirectoryService
import org.sdn.android.sdk.api.session.room.RoomService
import org.sdn.android.sdk.api.session.search.SearchService
import org.sdn.android.sdk.api.session.securestorage.SharedSecretStorageService
import org.sdn.android.sdk.api.session.signout.SignOutService
import org.sdn.android.sdk.api.session.space.SpaceService
import org.sdn.android.sdk.api.session.sync.FilterService
import org.sdn.android.sdk.api.session.sync.SyncService
import org.sdn.android.sdk.api.session.terms.TermsService
import org.sdn.android.sdk.api.session.thirdparty.ThirdPartyService
import org.sdn.android.sdk.api.session.typing.TypingUsersTracker
import org.sdn.android.sdk.api.session.user.UserService
import org.sdn.android.sdk.api.session.widgets.WidgetService
import org.sdn.android.sdk.api.util.appendParamToUrl
import org.sdn.android.sdk.internal.auth.SSO_UIA_FALLBACK_PATH
import org.sdn.android.sdk.internal.auth.SessionParamsStore
import org.sdn.android.sdk.internal.crypto.DefaultCryptoService
import org.sdn.android.sdk.internal.database.tools.RealmDebugTools
import org.sdn.android.sdk.internal.di.ContentScannerDatabase
import org.sdn.android.sdk.internal.di.CryptoDatabase
import org.sdn.android.sdk.internal.di.IdentityDatabase
...
import org.sdn.android.sdk.internal.util.createUIHandler
...
internal class DefaultSession @Inject constructor(
    ...
    private val nodeCapabilitiesService: Lazy<NodeCapabilitiesService>,
    ...
    override fun homeServerCapabilitiesService(): NodeCapabilitiesService = nodeCapabilitiesService.get()
    ...
    override fun getUiaSsoFallbackUrl(authenticationSessionId: String): String {
        val hsBas = sessionParams.edgeNodeConnectionConfig
                .homeServerUriBase
                .toString()
                .trim { it == '/' }
        return buildString {
