...
import org.sdn.android.sdk.api.auth.registration.RegistrationAvailability
import org.sdn.android.sdk.api.auth.registration.RegistrationResult
import org.sdn.android.sdk.api.auth.registration.RegistrationWizard
import org.sdn.android.sdk.api.auth.registration.toFlowResult
import org.sdn.android.sdk.api.failure.Failure
import org.sdn.android.sdk.api.failure.Failure.RegistrationFlowError
...
internal class DefaultRegistrationWizard(
    ...
    private suspend fun register(
        ...
        val session = sessionCreator.createSession(credentials, pendingSessionData.edgeNodeConnectionConfig, loginType)
