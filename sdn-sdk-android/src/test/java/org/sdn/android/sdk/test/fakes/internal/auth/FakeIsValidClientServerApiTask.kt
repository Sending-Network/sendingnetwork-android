...
import org.sdn.android.sdk.internal.auth.IsValidClientServerApiTask
import org.sdn.android.sdk.internal.auth.IsValidClientServerApiTask.Params
...
internal class FakeIsValidClientServerApiTask {
    ...
    fun verifyExecutionWithConfig(config: EdgeNodeConnectionConfig) {
