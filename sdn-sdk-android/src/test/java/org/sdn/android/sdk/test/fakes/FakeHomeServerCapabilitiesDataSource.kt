...
internal class FakeHomeServerCapabilitiesDataSource {
    val instance = mockk<NodeCapabilitiesDataSource>()

    fun givenHomeServerCapabilities(nodeCapabilities: NodeCapabilities) {
        every { instance.getNodeCapabilities() } returns nodeCapabilities
    }
}
